...
class TypeHandler(core.Handler):
    ...
    def __init__(self, library, finder):
        ...
        self.changers_lines = []
        self.delta = 0.0
        self.checked = [43, 75, 125, 126, 133, 206, 243, 323, 324, 318, 378, 389, 530, 634, 637, 104, 884, 898, 899, 959, 999, 1030, 1081, 1173, 1197, 1185, 1190, 1191, 1189, 1188, 1232, 1212, 270, 1268, 1269, 1274, 1335, 1334, 1352, 1522, 1525, 1703, 1704, 1707, 1747, 1746, 1748, 1789, 1796, 432, 1477, 1830, 1908, 2012, 2013, 2081, 2095, 2145]
